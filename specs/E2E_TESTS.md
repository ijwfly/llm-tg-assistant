...
Status: фаза 7 — инфраструктура, команды, outbox, ходы, стриминг, кнопки, входной конвейер, разрешения/вопросы/планы, сессии и темы, настройки/персона/голос/расход; обновляется каждой фазой.

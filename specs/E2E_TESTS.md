...
Status: фаза 8 — инфраструктура, команды, outbox, ходы, стриминг, кнопки, входной конвейер, разрешения/вопросы/планы, сессии и темы, настройки/персона/голос/расход, send_file/вывод инструментов/rewind; обновляется каждой фазой.
